...
import VeganImage from '../../../public/assets/image/vegan.png'
import VeganShadow from '../../../public/assets/image/vegan-shaddow.png'
...
const CategoriesCard = ({category}) => {
  return (
    <div className="w-[180px] h-[152px] rounded-[30px] bg-[#F1F8F6] flex flex-col items-center justify-between pb-[30px]">
      ...
      {/* Text */}
      <p className="text-black font-semibold text-[18opx] leading-[22px] mt-auto capitalize">{category.title}</p>
    </div>
  );
};
